...
- **Модуль 7 (Локальные модели и RAG)** — превращает спецификацию и `AGENTS.md` из «положили в каждый промпт» в RAG-индекс над всей кодовой базой; даёт альтернативу frontier-моделям там, где код не должен покидать периметр.
